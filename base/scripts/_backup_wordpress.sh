...
function screenshot_before () {
  local BACKUP_PATH_TIMESTAMP="${BACKUP_PATH}/wp-backup_${TIMESTAMP}"
  cd $BACKUP_PATH_TIMESTAMP
  pageres https://www.google.com --filename="image_before"
}

function screenshot_after () {
  local BACKUP_PATH_TIMESTAMP="${BACKUP_PATH}/wp-backup_${TIMESTAMP}"
  cd $BACKUP_PATH_TIMESTAMP
  pageres https://www.google.com --filename="image_after"
}
##########################################################################
# Main
##########################################################################
